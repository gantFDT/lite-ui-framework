...
function UserSelectorEdit(props: any, ref: any) {
    ...
    return <div id={selectorEleKey} ref={ref}><UserSelector  {...restProps} /></div>
}
export default React.forwardRef(UserSelectorEdit)
