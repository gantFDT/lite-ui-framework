...
import { SmartTable, UserGroupSelector, UserGroupSelectorEdit } from '@/components/specific'
...
const dataSource = [
    {
        id: '1',
        name: 'Mr Zhang',
        userGroup: 'GBv2dTaYJiskEKxctyt',
        desc: 'no description now'
    },
    {
        id: '2',
        name: 'Ms Ling',
        userGroup: 'mC0XzAsAiDZw44wcBVw',
