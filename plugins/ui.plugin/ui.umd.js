(function (global, factory) {
  ...
  (global = global || self, global['gant-ui'] = factory(global.window.React, global.window.antd));
  ...
  */
  ...
  var CloudDownloadOutline_1 = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  ...
  var CustomTreeSelect = function CustomTreeSelect(props) {
    var propsOnChange = props.onChange,
        ...
        resetProps = _objectWithoutProperties(props, ["onChange", "value"]);

    var _onChange = React.useCallback(function (pathname, filename) {
      propsOnChange("".concat(pathname, "/").concat(filename));
    }, []);

    var pathArray = React.useMemo(function () {
      return value.split('/');
    }, [value]);
    var treeValue = React.useMemo(function () {
      return pathArray.slice(0, -1).join('/') || '/';
    }, [pathArray]);
    var pathValue = React.useMemo(function () {
      return pathArray.slice(-1)[0];
    }, [pathArray]);
    var ref = React.useRef();
    return React__default.createElement("div", {
      ref: ref
    }, React__default.createElement(antd.Input.Group, {
      compact: true
    }, React__default.createElement(antd.TreeSelect, _extends({}, resetProps, {
      labelInValue: true,
      showSearch: true,
      ...
      onChange: function onChange(_ref) {
        var treePath = _ref.value;
        return _onChange(treePath, pathValue);
      },
      value: {
        value: treeValue
      }
      ...
      onChange: function onChange(e) {
        return _onChange(treeValue, e.target.value);
      }
    })));
  };

  var formatRouter = function formatRouter(data) {
  ...
  var SelectPath = function SelectPath(props) {
    var resetProps = _extends({}, props);

    var _useContext = React.useContext(APIContext),
        api = _useContext.api;
    ...
    var getRoutes = React.useCallback(
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    ...
    return React__default.createElement(CustomTreeSelect, _extends({
      treeData: dataSource
    }, resetProps));
  };

  var SelectFolder = function SelectFolder(props) {
    var resetProps = _extends({}, props);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              _ref2 = _context.sent;
              data = _ref2.data;
              folder = data.reduce(function (list, item) {
                // 只能添加到已存在的业务模块中
  ...
  var AddModal = function AddModal(_ref) {
    ...
    var initialValues = React.useMemo(function () {
      return {
        routePath: path,
        // folderPath: path
        folderPath: "/sysmgmt".concat(path)
      };
    }, [path]);
    ...
    return React__default.createElement(antd.Modal, _extends({
      ...
      onOk: function onOk() {
        ...
        form.validateFields().then(function (values) {
          ...
          if (Array.isArray(err)) {
            var msg = err.map(function (_ref2) {
            ...
            antd.message.error(msg, 8);
          } else {
            antd.message.error(err, 3);
          }
        }).finally(function () {
          setloading(false);
        });
      ...
      onCancel: onCancel
    }, props), React__default.createElement(antd.Form, {
      layout: "vertical",
      form: form,
      ...
      label: "\u6A21\u677F\u9875\u9762\u8DEF\u5F84",
      name: "routePath"
    }, React__default.createElement(SelectPath, null)), React__default.createElement(antd.Form.Item, {
      label: "\u6A21\u677F\u9875\u9762\u76EE\u5F55",
      name: "folderPath"
    }, React__default.createElement(SelectFolder, null))));
  };
  ...
  var Template = (function (_ref) {
    var snapshot = _ref.snapshot,
        path = _ref.path,
        props = _objectWithoutProperties(_ref, ["snapshot", "path"]);
    ...
    return React__default.createElement(React__default.Fragment, null, React__default.createElement(antd.Card, {
      cover: React__default.createElement("div", {
        style: containerStyle
      }, snapshot ? React__default.createElement("div", {
        style: _objectSpread2({}, snapshotStyle, {
          backgroundImage: "url(data:image/png;base64,".concat(snapshot, ")")
        })
      }) : null),
      actions: [React__default.createElement(CloudDownload, {
        onClick: onClick
      })],
      bodyStyle: bodyStyle
    ...
    })), React__default.createElement(AddModal, {
      visible: visible,
      title: "\u6DFB\u52A0\u6A21\u677F",
  ...
  var Layout = (function (props) {
    ...
    var queryList = React.useCallback(function () {
      setloading(true);
      api.callRemote({
    ...
    if (loading) return React__default.createElement("div", {
      style: {
        "text-align": "center",
        "border-radius": 4,
        "margin-bottom": 20,
    ...
    return React__default.createElement("div", {
      ...
      gutter: 24
    }, list.map(function (config) {
      return React__default.createElement(antd.Col, layout, React__default.createElement(Template, config));
    })));
  });
            ...
            case 0:
              api.addPanel({
                ...
                component: function component() {
                  return React__default.createElement(APIContext.Provider, {
                    value: {
                      api: api
                    }
